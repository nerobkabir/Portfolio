...
const ALL_PROJECTS: Project[] = [
  {
    ...
    image: "https://i.ibb.co/RGRwvrZG/Screenshot-2026-06-03-221833.png",
    images: [
      "https://i.ibb.co/RGRwvrZG/Screenshot-2026-06-03-221833.png",
      "https://i.ibb.co/LDJX7hRJ/Screenshot-2026-06-03-221913.png",
      "https://i.ibb.co/d4VDWSFt/Screenshot-2026-06-03-221953.png",
      "https://i.ibb.co/JRqcTbYc/Screenshot-2026-06-03-222032.png",
      "https://i.ibb.co/TD0n7ZVS/Screenshot-2026-06-03-222220.png",
      "https://i.ibb.co/k2x7WZSw/Screenshot-2026-06-03-222429.png",
    ],
...

{
  ...
  },
  {
    ...
    images: [
      "https://placehold.co/800x500/0a0f1e/6366f1?text=Hintro+Dashboard",
      "https://placehold.co/800x500/0a0f1e/6366f1?text=Active+User+State",
      "https://placehold.co/800x500/0a0f1e/6366f1?text=New+User+State",
      "https://placehold.co/800x500/0a0f1e/6366f1?text=Dark+Mode",
      "https://placehold.co/800x500/0a0f1e/6366f1?text=Recent+Calls",
      "https://placehold.co/800x500/0a0f1e/6366f1?text=Feedback+Modal",
    ],
    shortDesc: "Pixel-perfect dashboard built from a Figma design — real call session data, dark mode, two user states & responsive layout.",
    tech: ["Next.js 14", "Tailwind CSS", "Axios", "Lucide React", "localStorage"],
    fullDesc: "A frontend internship assignment — building a mock dashboard for Hintro based on a provided Figma design and mock REST APIs. Handles two distinct user states: a new user with empty state and an active user with sessions, stats, and call history.",
    liveLink: "https://hintro-dashboard-theta.vercel.app",
    githubLink: "https://github.com/nerobkabir/Hintro-Dashboard",
    challenges: "Pixel-perfect Figma implementation · dual user-state management · CSS custom-property theming · parallel API calls with Promise.all",
    improvements: "Real auth flow, backend feedback storage, WebSocket live updates, push notifications.",
    features: [
      "Two user states — active (populated) & new (empty state)",
      "4 stat cards: Sessions, Avg Duration, AI Used, Last Session",
      "Recent calls grouped by date with context menu",
      "Dark / light mode via CSS custom properties",
      "Persistent theme & feedback via localStorage",
  ...
  },
  {
    ...
    images: [
      "https://placehold.co/800x500/0a0f1e/f43f5e?text=WeeroHub+Home",
      "https://placehold.co/800x500/0a0f1e/f43f5e?text=Products+Page",
      "https://placehold.co/800x500/0a0f1e/f43f5e?text=Dark+Mode",
      "https://placehold.co/800x500/0a0f1e/f43f5e?text=Auth+Flow",
      "https://placehold.co/800x500/0a0f1e/f43f5e?text=Add+Product",
      "https://placehold.co/800x500/0a0f1e/f43f5e?text=Docker+Setup",
    ],
    shortDesc: "MERN product management app — JWT auth, owner-only CRUD, real-time search, price filter & Docker support. Built for Weero Digital.",
    tech: ["React.js", "Node.js", "Express.js", "MongoDB", "JWT", "Docker", "Tailwind CSS"],
    fullDesc: "WeeroHub is a full-stack product management application built as a practical task for Weero Digital. Features JWT-based auth, owner-only edit/delete, server-side pagination, real-time product search, price range filtering, dark/light mode, and Docker Compose support for seamless local dev.",
    liveLink: "https://weero-product-app.vercel.app",
    githubLink: "https://github.com/nerobkabir/weero-product-app",
    challenges: "Owner-only authorization guards · server-side pagination with filters · Docker Compose multi-service setup · JWT httpOnly token flow",
    improvements: "Image upload to cloud storage, product categories, analytics, role-based admin panel.",
    features: [
